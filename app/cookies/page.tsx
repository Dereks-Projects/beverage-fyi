...
export const metadata: Metadata = {
  title: 'Cookie Policy | Beverage.fyi',
  description: 'Cookie Policy for Beverage.fyi - learn how we use cookies and how to manage your preferences.',
  alternates: {
    canonical: 'https://beverage.fyi/cookies',
  },
}
      ...
      <div className={styles.contentWrapper}>
        <section className={styles.section}>
          ...
          <div className={styles.content}>
            <p>
              This Cookie Policy explains how Beverage.fyi uses cookies and similar tracking technologies when you
            ...
            <ul>
              <li>
                <strong>We do not sell your data:</strong> We never sell, rent, or trade any data collected
                through cookies to third parties
              </li>
              <li>
                <strong>We do not harvest data for advertising:</strong> We do not use cookies to build
                advertising profiles or target you with ads
              </li>
              <li>
                <strong>We do not track across websites:</strong> We do not use cookies to track your browsing
                activity on other websites
              </li>
              <li>
                <strong>We do not share with data brokers:</strong> We do not share cookie data with data
                aggregation companies or marketing databases
              </li>
            </ul>
            ...
            <p>
              ...
              DNT signals, our website does not currently respond to DNT browser signals.
            </p>
