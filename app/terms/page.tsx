...
export const metadata: Metadata = {
  title: 'Terms of Use | Beverage.fyi',
  description: 'Terms of Use for Beverage.fyi - please read these terms carefully before using our website.',
  alternates: {
    canonical: 'https://beverage.fyi/terms',
  },
}
      ...
      <div className={styles.contentWrapper}>
        <section className={styles.section}>
          ...
          <div className={styles.content}>
            <p>
              Welcome to Beverage.fyi. By accessing or using our website and services, you agree to be bound by
              these Terms of Use. Please read them carefully before using our platform.
            </p>

            <h2>Acceptance of Terms</h2>
            <p>
              By accessing, browsing, or using Beverage.fyi, you acknowledge that you have read, understood, and
            ...
            <p>
              Beverage.fyi contains educational content related to alcoholic beverages, including wine, spirits,
              beer, and sake. By using this website, you confirm that you are of legal drinking age in your
              jurisdiction. If you are under the legal drinking age, you may not access or use this website.
            </p>

            <h2>Description of Service</h2>
            <p>
              Beverage.fyi provides educational content and resources related to wine, spirits, beer, sake,
              and the hospitality industry. Our services include articles, guides, reference materials,
              and related educational content designed for hospitality professionals and beverage enthusiasts.
            </p>

            <h2>Intellectual Property Rights</h2>
            <p>
              All content on Beverage.fyi, including text, graphics, logos, images, photographs, and software, is the
              property of Beverage.fyi or its content creators and is protected by United States and international
            ...
            <p>
              The educational content provided on Beverage.fyi is for informational and educational purposes only.
            ...
            <p>
              Beverage.fyi promotes responsible and moderate consumption of alcoholic beverages. Our educational
              content is intended to enhance knowledge and appreciation of wine, spirits, beer, and sake, not to
            ...
            <p>
              ...
              by Beverage.fyi. We have no control over and assume no responsibility for the content, privacy policies,
            ...
            <p>
              To the fullest extent permitted by law, Beverage.fyi shall not be liable for any indirect, incidental,
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Beverage.fyi and its owners, officers, employees,
