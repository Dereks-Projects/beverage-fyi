...
export const metadata: Metadata = {
  title: 'Privacy Policy | Beverage.fyi',
  description: 'Privacy Policy for Beverage.fyi - learn how we collect, use, and protect your information.',
  alternates: {
    canonical: 'https://beverage.fyi/privacy',
  },
}
      ...
      <div className={styles.contentWrapper}>
        <section className={styles.section}>
          ...
          <div className={styles.content}>
            <p>
              At Beverage.fyi, we respect your privacy and are committed to protecting your personal information.
            ...
            <ul>
              <li>
                ...
                operating our website and delivering our services, under strict confidentiality agreements
              </li>
              <li>
              ...
              <li>
                ...
                where user information may be transferred as part of the transaction
              </li>
            </ul>
            ...
            <p>
              ...
              under the legal drinking age in their jurisdiction. We do not knowingly collect personal information
              from minors. If you believe we have inadvertently collected information from a minor, please contact us immediately.
            </p>
